...
const navItems = [ "About", "Contact","project",'Home'];
          ...
          <div className="flex items-center h-full">
            ...
            >
              <audio
                ref={audioElementRef}
                className="hidden"
                src="/audio/New trending flute BGM 4K no copyright Free Download nocopyrightmusic new trending 2.mp3"
                loop
              />
              {[1, 2, 3, 4].map((bar) => (
                <div
